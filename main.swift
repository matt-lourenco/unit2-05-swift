...
print("Vehicle 1")
let vehicle1: Vehicle = try Vehicle(licensePlate: "AAAA111", colour: Vehicle.Colours.GREY)
print(vehicle1.getStatus())
vehicle1.accelerate(amount: 5)
print(vehicle1.getStatus())
vehicle1.accelerate(amount: 20)
print(vehicle1.getStatus())
vehicle1.brake(amount: 30)
print(vehicle1.getStatus())

print("\nVehicle 2")
let vehicle2: Vehicle = try Vehicle(licensePlate: "BBBB222", colour: Vehicle.Colours.BLUE)
print(vehicle2.getStatus())
try vehicle2.setLicensePlate(newPlate: "JAVAWNS")
print(vehicle2.getStatus())
vehicle2.setColour(newColour: Vehicle.Colours.RED)
print(vehicle2.getStatus())